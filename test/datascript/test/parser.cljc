...
(deftest bindings
  ...
  (is #?(:cljd (thrown-msg? #"Cannot parse binding"
               (dp/parse-binding :key))
         :default (thrown-with-msg? ExceptionInfo #"Cannot parse binding"
                    (dp/parse-binding :key)))))
...
(deftest with
  ...
  (is #?(:cljd (thrown-msg? #"Cannot parse :with clause"
               (dp/parse-with '[?x _]))
         :default (thrown-with-msg? ExceptionInfo #"Cannot parse :with clause"
                    (dp/parse-with '[?x _])))))
